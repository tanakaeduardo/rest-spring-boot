package com.tanaka.unittests.mockito.services;
...
class PersonServicesTest {
	...
	void testFindById() {
		...
		assertNotNull("Address Test1",result.getAddress());
		assertNotNull("First Name Test1",result.getFirstName());
		assertNotNull("Last Name Test1",result.getLastName());
		assertNotNull("Female",result.getGender());
	}
